...
{
*INPUT FILES
Grid ="n1_23_FDSOI_presimulation_fps.tdr"
* physical parameters
...
quasistationary (InitialStep=0.005 MaxStep = 0.1 MinStep=1e-8
...
{coupled { Poisson Electron Hole } 
CurrentPlot ( Time = (range = (0 2) intervals = 200)) 
Plot(FilePrefix = "IDVG_VD0d2_" Time=(2))}
}